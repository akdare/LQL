            ...
            e.on("click", '[data-button-action="add-to-cart"]', function (e) {
                if ((e.preventDefault(), (0, r.default)("#quantity_wanted").val() > (0, r.default)("[data-stock]").data("stock") && 0 === (0, r.default)("[data-allow-oosp]").data("allow-oosp").length))
                    ...
                    r.default
                        ...
                        .fail(function (e) {
                            $('body').append("<div id=\"blockcart-modal\" class=\"modal fade in custom-error\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" style=\"display: block;z-index:10000\">\n" +
                                "  <div class=\"modal-dialog\" role=\"document\" style='border: 6px solid #d4bdc1;'>\n" +
                                "    <div class=\"modal-content\">\n" +
                                "      <div class=\"modal-header\">\n" +
                                "        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" onclick=\"$('#blockcart-modal.custom-error').hide(250);setTimeout(function() { $('#blockcart-modal.custom-error').remove() }, 500); $('#cboxOverlay').hide()\">\n" +
                                "          <span aria-hidden=\"true\">×</span>\n" +
                                "        </button>\n" +
                                "        <h4 class=\"modal-title h6 text-sm-center\" id=\"myModalLabel\" style='text-align: center!important;'><b>Un vendeur à la fois</b></h4>\n" +
                                "      </div>\n" +
                                "      <div class=\"modal-body\">\n" +
                                "        <div class=\"row\">\n" +
                                "          <div class=\"col-md-12\">\n" +
                                "            <div>\n" +
                    "                            <p style='text-align: center;font-size: 1.125rem;'>Minute papillon, il semblerait que vous ayez déjà un article de l'un de nos vendeurs dans votre panier.<br /> " +
                                "                   Vous devez d'abord valider ou vider votre panier avant d'effectuer un achat chez un autre vendeur." +
                                "               </p>\n" +
                                "               <div style='text-align: center;display: block;margin-top:28px'>\n" +
                                "                <a href='"+ e.responseText +"' class=\"btn btn-primary\" style='margin-bottom: 10px;white-space: break-spaces;'><i class=\"material-icons rtl-no-flip\"></i>Voir la boutique de mon vendeur</a>" +
                                "                <a href=\"//lequartierlitteraire.com/panier?action=show\" style='margin-bottom: 10px;white-space: break-spaces;' class=\"btn btn-primary\"><i class=\"material-icons rtl-no-flip\"></i>Voir mon panier</a>\n" +
                                "              </div>" +
                                "            </div>\n" +
                                "          </div>\n" +
                                "        </div>\n" +
                                ...
                                "    </div>\n" +
                                "  </div>\n" +
                                "</div>").hide().finish().fadeTo(500, 1);

                                $('#cboxOverlay').css('background', 'rgba(0, 0, 0, 0.5) none repeat 0 0').show();
