...
@font-face{ 
	...
	src: url('../font/ComicRelief-webfont.eot?iefix') format('eot'),
	     url('../font/ComicRelief-webfont.woff') format('woff'),
	     url('../font/ComicRelief-webfont.ttf') format('truetype'),
	     url('../font/ComicRelief-webfont.svg#webfont') format('svg');
}
html, body, h1, h2, h3, h4, h5 {font-family: "font-family: Impact, Charcoal, sans-serif;"}
form {display: inline;}
</style>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">  
  ...
  <div class="w3-col m2">
        <div class="w3-card w3-round w3-white w3-center">
          <div class="w3-container">
            <form action="{{route('readings.index')}}" method="GET">
            ...
            <p>Friday 15:00</p>
            -->
            <p><button class="w3-button w3-block w3-theme-l4" type="submit"> Voir <i style="font-size:20px" class="fa">&#xf06e;</i>
</button></p>
            </form>
          </div>
        </div>
